...
export default function OnsenDetailPageClient({
  onsen,
  reviews,
  userMap,
}: {
  onsen: Database["public"]["Tables"]["onsen"]["Row"];
  reviews: Database["public"]["Tables"]["review"]["Row"][];
  userMap: Record<string, { name: string; image_url?: string }>;
}) {
  const avgRating =
