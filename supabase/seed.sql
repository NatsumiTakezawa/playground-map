...
INSERT INTO public.users (id, name, email, role) VALUES
  ...
  ('00000000-0000-0000-0000-000000000004', 'ゲスト', 'guest@example.com', 'user');
...
INSERT INTO public.onsen (id, name, geo_lat, geo_lng, description, tags, images) VALUES
  ...
  ('10000000-0000-0000-0000-000000000004', '松江温泉（画像なし）', 35.4800, 133.0600, '画像が未登録の温泉。', ARRAY['穴場'], NULL);
...
INSERT INTO public.review (onsen_id, user_id, rating, comment) VALUES
  ...
  ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 4, 'アクセスも便利でおすすめです。'),
  ...
  ('10000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004', 5, '穴場でゆっくりできました。');
